...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <Icon icon={ArrowDown01Icon} data-slot="accordion-trigger-icon" size={16} className="pointer-events-none size-4 shrink-0 group-aria-expanded/accordion-trigger:hidden" />
        <Icon icon={ArrowUp01Icon} data-slot="accordion-trigger-icon" size={16} className="pointer-events-none hidden size-4 shrink-0 group-aria-expanded/accordion-trigger:inline" />
      </AccordionPrimitive.Trigger>
